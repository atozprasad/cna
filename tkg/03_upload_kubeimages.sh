...
govc object.mv /$GOVC_DATACENTER/vm/photon-3-v1.17.3+vmware.1 $TKGVMFOLDER
...
govc object.mv /$GOVC_DATACENTER/vm/photon-3-capv-haproxy-v0.6.2+vmware.2 $TKGVMFOLDER
